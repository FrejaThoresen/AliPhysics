...
public:
  ...
  //------------------------------------------------------------------
  void CoupleFilter(AliAnalysisManager* mgr)
  {
  ...
  //------------------------------------------------------------------
  void CoupleVertexing(AliAnalysisManager* mgr)
  {
  ...
  //------------------------------------------------------------------
  void CoupleJPsiFilter(AliAnalysisManager* mgr)
  {
  ...
  //------------------------------------------------------------------
  void CoupleJetAN(AliAnalysisManager* mgr, Bool_t physicsSelection)
  {
  ...
  //------------------------------------------------------------------
  void CoupleForward(AliAnalysisManager* mgr)
  {
  ...
  void CreateTasks(AliAnalysisManager* mgr)
  {
    ...
    if (fOptions.Has("esd-filter"))   CoupleFilter(mgr);
    ...
    if (vertexing)                      CoupleVertexing(mgr);
    if (fOptions.Has("jpsi-filtering")) CoupleJPsiFilter(mgr);
    if (d0Decay)                        CoupleD0Decay();
    if (fOptions.Has("jetan"))          CoupleJetAN(mgr, physicsSelection);
    if (fOptions.Has("forward-nch") && physicsSelection) CoupleForward(mgr);
  }
  //------------------------------------------------------------------
  /** 
